...
const styles = StyleSheet.create({
  ...
  title: {
    ...
    color: "#333",
    marginBottom: 12,
    lineHeight: Math.min(36, Dimensions.get('window').width * 0.09),
  },
  description: {
    fontSize: 16,
    color: "#666",
  ...
  metaContainer: {
    flexDirection: Dimensions.get('window').width < 350 ? 'column' : 'row',
    ...
    shadowOpacity: 0.1,
    shadowRadius: 2,
    gap: Dimensions.get('window').width < 350 ? 8 : 0,
  },
  metaItem: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: Dimensions.get('window').width < 350 ? 'flex-start' : 'center',
  },
  metaText: {
    marginLeft: 6,
    fontSize: 14,
  ...
  purchaseButton: {
    ...
    shadowOpacity: 0.2,
    shadowRadius: 4,
    flex: Dimensions.get('window').width < 400 ? 0 : 1,
    justifyContent: 'center',
    minHeight: 54,
  },
  ...
  favoriteButton: {
    width: Dimensions.get('window').width < 400 ? '100%' : 54,
    height: 54,
    borderRadius: 12,
    backgroundColor: '#fff',
    borderWidth: 2,
    ...
    shadowOpacity: 0.2,
    shadowRadius: 4,
    flexDirection: Dimensions.get('window').width < 400 ? 'row' : 'column',
  },
